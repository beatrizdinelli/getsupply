# Migrating web UI to GetSupply Design System

Read `artifacts/getsupply-ds/docs/AGENTS.md` and
`artifacts/getsupply-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/getsupply-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/getsupply-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/getsupply-ds/hooks/use-toast`
