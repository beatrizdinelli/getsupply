# Consuming GetSupply Design System in Expo apps

Read `artifacts/getsupply-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/getsupply-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/getsupply-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/getsupply-ds/lib/native-theme";
import { useColors } from "@workspace/getsupply-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/getsupply-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/getsupply-ds/components/native/badge";
import { Button } from "@workspace/getsupply-ds/components/native/button";
import { Card } from "@workspace/getsupply-ds/components/native/card";
```
...
Import and render
`@workspace/getsupply-ds/components/native/button`, then run Expo
