# GetSupply Design System design system
...
workspace package (`@workspace/getsupply-ds`): other artifacts depend
...
`@workspace/getsupply-ds/components/...`. Never use a `@/` alias inside
...
for `@workspace/getsupply-ds` and renders mockups using this package's
theme and components.

## Consuming this package

Never copy token values, component source, hooks, or these docs into a consuming
artifact. Add `@workspace/getsupply-ds` as a `workspace:*` dependency,
run `pnpm install`, and import directly from this package.

Read only the guides required by the current task:

- Building or styling web UI: `artifacts/getsupply-ds/docs/consuming-web.md`
- Building or styling Expo UI: `artifacts/getsupply-ds/docs/consuming-expo.md`
- Replacing an existing or scaffolded web theme/component library:
  `artifacts/getsupply-ds/docs/migrating-web.md`
- Replacing existing or scaffolded Expo theme/hooks/components:
  `artifacts/getsupply-ds/docs/migrating-expo.md`
