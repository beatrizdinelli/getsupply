...
const seedSuppliers: Supplier[] = [
  { id: "s1", companyName: "Papelaria Aurora", cnpj: "12.345.678/0001-01", categories: ["Caixas", "Papel"], region: "São Paulo, SP", moq: "500 unidades", capacity: "Até 50 mil/mês", rating: 4.9, reviews: 28, verified: true, description: "Especialistas em caixas rígidas e embalagens de papel para marcas que estão começando." },
  { id: "s2", companyName: "Norte Flex", cnpj: "23.456.789/0001-02", categories: ["Sacolas", "Flexíveis"], region: "Blumenau, SC", moq: "1.000 unidades", capacity: "Até 100 mil/mês", rating: 4.8, reviews: 19, verified: true, description: "Impressão flexográfica com acabamento cuidadoso e lotes sob medida." },
